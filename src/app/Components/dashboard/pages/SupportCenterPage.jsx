    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="border border-gray-200 rounded-lg p-4 text-center hover:border-primary hover:shadow-md transition-all">
              <div className="w-12 h-12 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto mb-3">
                <FileText size={24} />
              </div>
              <h3 className="font-medium mb-2">Help Articles</h3>
              <p className="text-sm text-gray-600 mb-3">Browse our knowledge base for answers to common questions</p>
            ...
            <div className="border border-gray-200 rounded-lg p-4 text-center hover:border-primary hover:shadow-md transition-all">
              ...
              <p className="text-sm text-gray-600 mb-3">Chat with our support team for immediate assistance</p>
              <button
            ...
            <div className="border border-gray-200 rounded-lg p-4 text-center hover:border-primary hover:shadow-md transition-all">
              ...
              <p className="text-sm text-gray-600 mb-3">Speak directly with our customer service team</p>
      ...
      {isLiveChatOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg max-w-md w-full h-[500px] flex flex-col animate-fade-in">
            ...
            <div className="p-4 border-t border-gray-200">
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
                />
